...
def displayPDF(file):
    ...
    pdf_display = F'<iframe src="https://drive.google.com/viewerng/viewer?embedded=true&url=data:application/pdf;base64,{base64_pdf}" width="100%" height="600" type="application/pdf"></iframe>'
